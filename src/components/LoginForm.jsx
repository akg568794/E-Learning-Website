        ...
        <form className='flex flex-col  w-full gap-y-4 mt-6' onSubmit={submitHandler}>
            <label>
                <p className='text-richblack-5 text-[0.875rem] mb-3 leading-[1.375rem] '>Email Address<sup className='text-pink-200 text-[0.875rem]'>*</sup></p>
                 <input className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px] border-b border-blue-400 ' required type="text" value={formData.email} placeholder='Enter email id' onChange={changeHandler}  name='email' />
            </label>
            <label className='relative'>
                <p className='text-richblack-5 text-[0.875rem] mb-3 leading-[1.375rem]'>Password<sup className='text-pink-200 text-[0.875rem]'>*</sup></p>
                 <input className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px] border-b border-blue-400' required type={showPassword? ("text"):("password")} value={formData.password} onChange={changeHandler} name='password' placeholder='Enter password' />
            ...
            <button className='mb-3 leading-[1.375rem] text-[1.125rem] font-semibold w-full bg-yellow-50 rounded-[8px] px-[12px] py-[8px] text-black ' >Sign In</button>
        </form>
    </div>
  )
}
